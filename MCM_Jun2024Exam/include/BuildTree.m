...
iTj(3,1,1) = 0; iTj(3,2,1) = 0; iTj(3,3,1) = 1; iTj(3,4,1) = 200/1000;
...
iTj(3,1,2) = 0; iTj(3,2,2) = 1; iTj(3,3,2) = 0; iTj(3,4,2) = (311.5-200)/1000;
iTj(4,1,2) = 0; iTj(4,2,2) = 0; iTj(4,3,2) = 0; iTj(4,4,2) = 1;

%2T3
iTj(1,1,3) = 1; iTj(1,2,3) = 0; iTj(1,3,3) = 0; iTj(1,4,3) = 675.5/1000;
...
iTj(3,1,4) = 0; iTj(3,2,4) = 1; iTj(3,3,4) = 0; iTj(3,4,4) = 126/1000;
iTj(4,1,4) = 0; iTj(4,2,4) = 0; iTj(4,3,4) = 0; iTj(4,4,4) = 1;

%4T5
iTj(1,1,5) = 0; iTj(1,2,5) = 0; iTj(1,3,5) = 1; iTj(1,4,5) = 150/1000;
...
iTj(3,1,6) = 1; iTj(3,2,6) = 0; iTj(3,3,6) = 0; iTj(3,4,6) = (679-150)/1000;
iTj(4,1,6) = 0; iTj(4,2,6) = 0; iTj(4,3,6) = 0; iTj(4,4,6) = 1;

%6T7
iTj(1,1,7) = 0; iTj(1,2,7) = 0; iTj(1,3,7) = 1; iTj(1,4,7) = 153/1000;
