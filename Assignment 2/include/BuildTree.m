...
iTj(3,1,2) = 0; iTj(3,2,2) = -1; iTj(3,3,2) = 0; iTj(3,4,2) = 213+60-175;
iTj(4,1,2) = 0; iTj(4,2,2) = 0; iTj(4,3,2) = 0; iTj(4,4,2) = 1;

%2T3
iTj(1,1,3) = 0; iTj(1,2,3) = 0; iTj(1,3,3) = -1; iTj(1,4,3) = -(431.5-326.5);
...
%3T4
iTj(1,1,4) = 1; iTj(1,2,4) = 0; iTj(1,3,4) = 0; iTj(1,4,4) = 145.5;
iTj(2,1,4) = 0; iTj(2,2,4) = 0; iTj(2,3,4) = 1; iTj(2,4,4) = 0;
iTj(3,1,4) = 0; iTj(3,2,4) = -1; iTj(3,3,4) = 0; iTj(3,4,4) = 326.50;
iTj(4,1,4) = 0; iTj(4,2,4) = 0; iTj(4,3,4) = 0; iTj(4,4,4) = 1;

%4T5
iTj(1,1,5) = 1; iTj(1,2,5) = 0; iTj(1,3,5) = 0; iTj(1,4,5) = 0;
iTj(2,1,5) = 0; iTj(2,2,5) = 1; iTj(2,3,5) = 0; iTj(2,4,5) = 35;
...
iTj(3,1,6) = 0; iTj(3,2,6) = 1; iTj(3,3,6) = 0; iTj(3,4,6) = 420-35;
