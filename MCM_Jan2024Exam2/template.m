...
% Important: It should not be all zeros, there probably is a problem in the
% function GetJacobian in the prismatic. If all put all joints rotational
% it kinda works
...
for i = t
    ...
    bRgt = bTt(1:3,1:3);
    [theta, h] = ComputeInverseAngleAxis(bRgt'*tRg);
    error_angular = bRgt*h'*theta; 
